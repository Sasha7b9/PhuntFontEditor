...
void Frame::CreateMenu()
{
    ...
    menuImport->Append(FILE_EXPORT_C, wxT("Импортировать в Си-файл"));
    menuImport->Append(FILE_EXPORT_BIN, wxT("Импортировать в двоичный файл"));
    fileMenu->AppendSubMenu(menuImport, wxT("Экспорт"), wxT("Экспортировать системный шрифт"));
